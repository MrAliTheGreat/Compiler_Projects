...
class_scope : LBRC (declarations)(constructor)(declarations) RBRC | LBRC (declarations) RBRC;
...
rel_expr: sum_expr COMPOP sum_expr{System.out.println("Operator:"+$COMPOP.text+"");} | sum_expr GT sum_expr{System.out.println("Operator:"+$GT.text+"");} | sum_expr LST sum_expr{System.out.println("Operator:"+$LST.text+"");} | sum_expr;
...
single_unit: var | func_call | TRUE | NULL | FALSE | STRING | NUM | LBRA func_args RBRA | LPAR expr RPAR | NEW ID LPAR func_args RPAR;
